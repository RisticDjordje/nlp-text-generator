...
from Common.Constants import c_frequencyCutoff
...
class TwitterVectorizer:
    ...
    def vectorize(self, text, vector_length):
        ...
        """
        # this is an abstract method, concrete implementations are provided in the subclasses
        pass
    ...
    def from_serializable(cls, contents):
        """
        Instantiate a TwitterVectorizer from serializable dictionary
